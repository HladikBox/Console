...
////以下是代码开始，请勿删除此行注释
////starthere
include USER_ROOT."/common/wechatplugin.inc.php";
$url="http://".$_SERVER["SERVER_NAME"].USER_PATH."api/test/wechatpaymentnotify";
$ret=WechatGenAppPaymentJSON($_REQUEST["subject"],$_REQUEST["price"],$_REQUEST["orderno"],$url);
outputJson($ret);
