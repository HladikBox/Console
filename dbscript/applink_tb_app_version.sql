...
CREATE TABLE `tb_app_version` (
  ...
  `commit_code` char(1) DEFAULT NULL,
  `code_package` blob,
  `commit_dbstructure` char(1) DEFAULT NULL,
  `dbstructure_package` blob,
  `commit_data` char(1) DEFAULT NULL,
  `data_package` blob,
  `commit_date` datetime DEFAULT NULL,
  `commit_comment` varchar(4000) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='代码版本管理';
...
-- Dump completed on 2017-01-03 16:55:31
